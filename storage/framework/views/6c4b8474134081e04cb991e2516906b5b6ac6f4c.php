    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input hidden>
                <form method="POST" action="<?php echo e(route('criarManutencao', $idVeiculo)); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH /var/www/resources/views/modal/manutencao.blade.php ENDPATH**/ ?>