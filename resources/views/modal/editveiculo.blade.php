    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('editarVeiculo', $data[0]['id']) }}" enctype="multipart/form-data">
                    @csrf

                    <div class="mb-3">
                        <label for="placaVeiculo" class="form-label">Placa</label>
                        <input type="text" class="form-control" id="placaVeiculo" name="placa"
                               aria-describedby="placaHelp" value="{{ $data[0]['placa'] }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="marcaVeiculo" name="marca"
                               aria-describedby="marcaHelp" value="{{ $data[0]['marca'] }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="modeloVeiculo" name="modelo"
                               aria-describedby="modeloHelp" value="{{ $data[0]['modelo'] }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="corVeiculo" name="cor"
                               aria-describedby="corHelp" value="{{ $data[0]['cor'] }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="versaoVeiculo" name="versao"
                               aria-describedby="versaoHelp" value="{{ $data[0]['versao'] }}" required>
